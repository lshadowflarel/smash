 ...
 * String2 = "World"<br>
 * <br>
 * <ConcatString string1="Hello" string2="World" result="Svar_result"/><br>
 * <br>
 * In this case, the result would be "HelloWorld" 
 * 
 * @author Paramai Supadulchai
 */
public class ConcatString extends Builtin {

    public final String ATTR_STRING1 = "string1";
	public final String ATTR_STRING2 = "string2";
     ...
     */
    public ConcatString(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public ConcatString(Node builtinAtom, World world, Integer place) {
     ...
     * - parameter string1<br>
     * - parameter string2<br>
     * - parameter result<br>
     * 
    ...
    public Boolean isMatched() {
        ...
        return new Boolean(builtinAtom.hasAttributeByLocalName(ATTR_STRING1) &&
    ...
    public Boolean isExecutable() { 
        return new Boolean(!builtinAtom.attributeByLocalName(ATTR_STRING1).isVariable() &&
     ...
     * in the "result" parameter. The function always
    ...
    public ExecutionResult execute() throws NotExecutableException {
        ...
        String originalString1 = builtinAtom.attributeByLocalName(ATTR_STRING1).getNodeValue();
		String originalString2 = builtinAtom.attributeByLocalName(ATTR_STRING2).getNodeValue();
		String resultVariable = builtinAtom.attributeByLocalName(ATTR_RESULT).getNodeValue();
		String result = originalString1 + originalString2;
        ...
        execResult.setResultDescription(" [" + resultVariable + " <- \"" + result + "\" = \"" +
										originalString1 + "\" + \"" + originalString2 + "\"]");
	    return execResult;
    }
