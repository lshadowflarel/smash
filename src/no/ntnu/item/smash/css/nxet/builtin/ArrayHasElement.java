...
public class ArrayHasElement extends Builtin {

    public final String ATTR_STRING = "array";
    public final String ATTR_STRING2 = "value";
     ...
     */
    public ArrayHasElement(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public ArrayHasElement(Node builtinAtom, World world, Integer place) {
    ...
    public ExecutionResult execute() throws NotExecutableException { 
        ...
        String value = builtinAtom.attributeByLocalName(ATTR_STRING2).getNodeValue();
