...
public class CurrentHour extends Builtin {
     ...
     */
    public CurrentHour(Node builtinAtom, World world, Integer place, PrintStream out) {
     ...
     * @param place The place the built-in is executed
     */
    public CurrentHour(Node builtinAtom, World world, Integer place) {
    ...
    public ExecutionResult execute() throws NotExecutableException {
        ...
        spec.addSpecialization(resultVariable, ""+hour);
